...
if ($ADMIN->fulltree) {
    ...
    $name = 'block_tb_course_nav/toggleclickontitle';
    $title = get_string(
        'toggleclickontitle',
        'block_tb_course_nav'
    );
    ...
    // Option: show labels.
    $name = 'block_tb_course_nav/toggleshowlabels';
    $title = get_string(
        'toggleshowlabels',
        'block_tb_course_nav'
    );
    ...
    $name = 'block_tb_course_nav/togglecollapse';
    $title = get_string(
        'togglecollapse',
        'block_tb_course_nav'
    );
    ...
    $name = 'block_tb_course_nav/toggletitles';
    $title = get_string(
        'toggletitles',
        'block_tb_course_nav'
    );
